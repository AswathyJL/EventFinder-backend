...
exports.addEventController = async (req,res) =>{
    ...
    console.log(eventName,eventDescription,startDate,endDate,startTime,endTime,location_city,location_state,location_link,maxRegistrationCount,isFree,entryFee,paymentMode,audienceType,eventType,tags);
    try {
        ...
        {
            const newEvent = new events({eventName,eventDescription,eventWebsite,startDate,endDate:eventEndDate,startTime,endTime,location_city,location_state,location_link,maxRegistrationCount,isFree,entryFee,paymentMode,audienceType,eventType,tags,userId})
            await newEvent.save()
